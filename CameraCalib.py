...
#program to calibrate images can be executed by going into cammand prompt, navigating to the required folder and writing the command :- python camera_calib.py --xml cameracalibration.xml 
        
#extrinsic and intrinsic pamameters will be saved in a json file        
